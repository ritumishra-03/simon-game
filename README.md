...
Simon's Game is a memory-based game where the player has to remember and repeat an increasing sequence of colors.
...
5. The game ends when an incorrect sequence is selected.

## Screenshot

![Simon's Game](screenshots.png)
